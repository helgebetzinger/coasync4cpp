...
//TEST_F(test_bind2thread, postReference ) {
//
//	MyBase obj;
//	int result;
//
//	auto f0 = bind2thread(dispatcher(), &MyBase::assignToRef, &obj, result, 2);
//	f0();
//	awaitTasksDone();
//
//	EXPECT_EQ(result, 2);
...
// TODO: 
//TEST_F(test_bind2thread, postConstReference) {
//
//	MyBase obj;
//	int result, src = 2;
//
//	auto f0 = bind2thread(dispatcher(), &MyBase::assignFromRef, &obj, result, src );
////	std::function< QueuePos(int *, const int&) > f0 =  bind2thread(dispatcher(), &MyBase::assignFromRef, &obj, result, src);
//	src = 3;
//	f0();
//	awaitTasksDone();
//
...
// für Send extra Test anlegen ... 

TEST_F(test_bind2thread, send) {
//	postCalls2Increment(100);
	awaitTasksDone();
	//EXPECT_EQ( mInvokeCount, 100);
}

//TEST_F(test_bind2thread, postAfterFinished ) {
//	postCalls2Increment(100);
//	tearDown();
//	postCalls2Increment(100);
//	EXPECT_EQ(mInvokeCount, 100);
